...
let options = {
    ...
    reportDataSource: "JSONDBFS", // "TestimAPI", "JSONDBFS" or "SQLServer"

    //testimAccessToken: "YOUR TESTIM API ACCESS TOKEN", // Required if reportDataSource = "TestimAPI"

     results: [resultID],

     testimToken: "oRbzxnMmfMRLJuFHPPPJH0gJFvuAWHrsr3gkIk3J5spNw8c3tm", // Required if reportDataSource = "JSONDBFS" or "SQLServer"
...
let configuration = {
     ...
     reportFileDirectory: "./TestimReports",
     jsondbfsPath:        ".", 
